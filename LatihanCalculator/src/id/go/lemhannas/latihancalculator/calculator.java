...
public class calculator extends JFrame {
	...
	public calculator() {
		...
		button_tambah.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				a = textField.getText();
		...
		button_kurang.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				a = textField.getText();
				textField.setText(a.concat("-"));
		...
		button_kali.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				a = textField.getText();
				textField.setText(a.concat("x"));
			}
		});
		...
		button_bagi.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				a = textField.getText();
				textField.setText(a.concat(":"));
		...
		button_hasil.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				b = a.split("+");
				textField.setText(b);
		...
		button_hasil.setBounds(185, 97, 89, 23);
